...
class MeilisearchRepository
  ...
  def configure_indices
    ...
    patch("/indexes/#{@file_index}/settings", {
      ...
      filterableAttributes: %w[fonds_id fonds_name decade period period_span origin_names archive_node_id source_date_start_unix source_date_end_unix ancestor_ids depth],
